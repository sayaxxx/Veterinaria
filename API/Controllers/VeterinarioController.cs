...
public class VeterinarioController : BaseApiController
{
    ...
    [HttpGet("veterinarioCirujano")]
    [MapToApiVersion("1.0")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<object>> veterinarioCirujano()
    {
        var entidad = await unitofwork.Veterinarios.veterinarioCirujano();
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Pager<object>>> veterinarioCirujanoPag([FromQuery] Params paisParams)
    {
        var entidad = await unitofwork.Veterinarios.veterinarioCirujano(paisParams.PageIndex, paisParams.PageSize, paisParams.Search);
